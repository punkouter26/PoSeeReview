...
namespace PoSeeReview.IntegrationTests.Api;
...
public class NearbyRestaurantsEndpointTests : IClassFixture<CustomWebApplicationFactory<Program>>
{
    ...
    public void GetNearbyRestaurants_CheckServiceRegistration_ShouldHaveRequiredServices()
    {
        ...
        try
        {
            var restaurantService = services.GetService<PoSeeReview.Core.Interfaces.IRestaurantService>();
            var googleMapsService = services.GetService<PoSeeReview.Infrastructure.Restaurants.GoogleMapsService>();
